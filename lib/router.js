...
router.get('/blockbeats/flash', lazyloadRouteHandler('./routes/blockbeats/news.js'));

router.get('/foresightnews/news', lazyloadRouteHandler('./routes/foresight/news.js'));

router.get('/odaily/newsflash', lazyloadRouteHandler('./routes/odaily/news.js'));

router.get('/chaincapture/newsflash', lazyloadRouteHandler('./routes/chaincapture/news.js'));

router.get('/panews/news', lazyloadRouteHandler('./routes/panews/news.js'));

router.get('/tokeninsight/news', lazyloadRouteHandler('./routes/tokeninsight/news.js'));
